...
To avoid writing raw HTML manually for every article, use this lightweight Python build script. It parses markdown files (`.md`), wraps them in clean HTML, and populates your public deployment folder.
...
1. Write your blog post in Markdown (`./posts/my-first-post.md`).
2. Run `python build_site.py` to compile Markdown files to `./website/`.
3. Execute `cdk deploy` to sync assets to AWS and refresh your live site.